...
const CartItemsContainer = () => {
	...
	return (
		<div className="_2hCJu">
			<div className="_1gEBu">
				{ cart ? (
					<div className="woo-next-cart-wrapper container">
						<div className="cart-header grid grid-cols-2 gap-4">
							...
							<div className="clear-cart text-right">
								<button className="px-4 py-1 border text-white rounded-sm w-auto" onClick={ ( event ) => handleClearCart( event ) } disabled={ clearCartProcessing }>
					...
					<div className="_2E17W">
						<div className="_32Hzd" >
							<div className="_2Tnvb">
								<div className="_1RCmr O_efo QA_eG" >
									<span className="_1YBrD" >E</span>
									<span className="_1YBrD" >m</span>
									<span className="_1YBrD" >p</span>
									<span className="_1YBrD" >t</span>
									<span className="_1YBrD" >y</span>
								</div>
								<div className="_3_ELA" >
									<Link href="/products" >
										<a className="JGkgU _3yyIC _1m-Jy _3Wm5U">back to objects<div className="_3pghL underline"></div></a>
									</Link>
								</div>
							</div>
						</div>
