...
const Price = ({ regularPrice = 0, salesPrice }) => {
    ...
    const discountPercent = ( regularPrice, salesPrice ) => {
        ...
        return {
            ...
            strikeThroughClass: formattedSalesPrice < formattedRegularPrice ? 'product-regular-price mr-2 line-through text-sm text-white font-normal' : ''
        }
    }
    ...
    return (
        <h6 className="product-price text-white font-semibold mr-3 mb-5">
            {/* Regular price */}
